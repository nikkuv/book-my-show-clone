// You are required to build backend system for a movie reservation service.
// The service will allow users to sign up, log in, browse movies, reserve seats for specific showtimes, 
// and manage their reservations. The system will feature user authentication, 
// movie and showtime management, seat reservation functionality, and reporting on reservations.

// Goal
// The goal of this project is to help you understand 
// how to implement complex business logic i.e. seat reservation and scheduling,
// thinking about the data model and relationships, and complex queries.

// Requirements
// We have intentionally left out the implementation details to encourage you to think about the design and implementation of the system.
// However here are some requirements that you can consider:
...
// Only admins should be able to promote other users to admin and be able to do things related to movie management, reporting, etc.
// Movie Management
...
// This project is quite complex and will require you to think about the design and implementation of the system
// You can use any programming language and database of your choice.
// I would recommend using a relational database such as MySQL or PostgreSQL.
// Once you have finished this project, you will have a good understanding of how to implement complex business logic, 
// think about the data model and relationships, and complex queries.
